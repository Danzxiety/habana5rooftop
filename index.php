...
<body class="bg-home" style="background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.46) 99%), url(&quot;assets/img/bg_ani.jpg&quot;) center / cover no-repeat;"><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    ...
    <div class="offcanvas offcanvas-end mt-3" tabindex="-1" id="offcanvas-list" style="max-width: 360px;border-top-left-radius: 15px;">
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="modal-galery">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-0 py-2" style="border-top-left-radius: 12px;border-top-right-radius: 12px;">
                    <h4 class="modal-title text-uppercase fw-bold" style="letter-spacing: 2px;">Galería</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body px-1">
                    <section class="photo-gallery">
                        <div class="container">
                            <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 row-cols-xl-3 photos" data-bss-baguettebox="">
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0043.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0043.jpg" style="height: 100%;border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0031.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0031.jpg" style="height: 100%;border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0013.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0013.jpg" style="border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0026.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0026.jpg" style="border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0044.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0044.jpg" style="border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0050.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0050.jpg" style="border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0048.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0048.jpg" style="border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0037.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0037.jpg" style="height: 100%;border-radius: 12px;"></a></div>
                                <div class="col item"><a href="assets/img/IMG-20240407-WA0029.jpg"><img class="img-fluid" src="assets/img/IMG-20240407-WA0029.jpg" style="height: 100%;border-radius: 12px;"></a></div>
                            </div>
                        </div>
                    </section>
                </div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="modal-map">
...
<div id="reservas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header pt-3 border-0">
      <h4 class="modal-title text-uppercase fw-bold" style="letter-spacing: 2px;">RESERVAR</h4>
...
<!-- End Form -->
                                ...
                                <button type="submit" class="btn fw-semibold reserva_wts w-100 btn-dark py-3 mt-4 mx-1 rounded-3">Enviar reservación</button>
