...
<main>
          ...
          <section class="bg-home justify-content-center alig-items-center"  style="background: center;    align-content: center; background-image: url(assets/img/bg/bg.jpg); background-color: #ffffff; background-size: cover; min-height: 100vh;">
            <div class="container">
...
<div class="offcanvas offcanvas-bottom mx-lg-5" style="border-radius: 20px 20px 0px 0px; box-shadow: 1px -2px 20px #00000038;" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
  <div class="offcanvas-header border-0 pb-1">
    <img src="assets/img/logos/logo_hbn5.webp" width="100" alt="">
...
if ($db->connect_error) {
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    while ($row2 = $result2->fetch_assoc()) {
      ...
      echo '<p class="h4 fw-bold mb-0" style="color: #af2807;letter-spacing:-0.04px !important;">' . htmlspecialchars($row2['precio_producto']) . '<span class="ms-1" style="font-size:10px">' . htmlspecialchars($row2['moneda_producto']) . '</span></p>';
      echo '</div></a>
      </div>';
    }
